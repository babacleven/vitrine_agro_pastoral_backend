...
export interface ApiActiviteActivite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categorie: Schema.Attribute.Enumeration<
      ['agriculture', ' \u00E9levage', ' transformation,', 'autre']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEntrepriseEntreprise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descriptionAccueil: Schema.Attribute.Blocks;
    email: Schema.Attribute.Email;
